...
- The library is organized under `src/plotlp` into two main parts:
...
- The main object is defined in:
  - `myname.py`
  - and imported as: `from plotlp import myname`
...
- All such objects become importable from the package root directly with ```from plotlp import myname```.
